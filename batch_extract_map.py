...
# Keys are pre-normalized (uppercase, no accents, no special chars) to match _norm_muni() output
_PE_RAW = {
    # ── Αττική: Κεντρικός Τομέας Αθηνών ──
    "ΑΘΗΝΑΙΩΝ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΑΘΗΝΩΝ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΖΩΓΡΑΦΟΥ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΔΑΦΝΗΣ ΥΜΗΤΤΟΥ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΒΥΡΩΝΟΣ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΗΛΙΟΥΠΟΛΕΩΣ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΗΛΙΟΥΠΟΛΗΣ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΓΑΛΑΤΣΙΟΥ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΦΙΛΑΔΕΛΦΕΙΑΣ ΧΑΛΚΗΔΟΝΟΣ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΝΕΑΣ ΦΙΛΑΔΕΛΦΕΙΑΣΝΕΑΣ ΧΑΛΚΗΔΟΝΟΣ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    "ΚΑΙΣΑΡΙΑΝΗΣ": "ΠΕ Κεντρικού Τομέα Αθηνών",
    # ── Αττική: Νότιος Τομέας Αθηνών ──
    "ΠΑΛΑΙΟΥ ΦΑΛΗΡΟΥ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΓΛΥΦΑΔΑΣ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΑΛΙΜΟΥ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΚΑΛΛΙΘΕΑΣ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΜΟΣΧΑΤΟΥΤΑΥΡΟΥ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΝΕΑΣ ΣΜΥΡΝΗΣ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΑΓΙΟΥ ΔΗΜΗΤΡΙΟΥ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΒΑΡΗΣΒΟΥΛΑΣΒΟΥΛΙΑΓΜΕΝΗΣ": "ΠΕ Νοτίου Τομέα Αθηνών",
    "ΕΛΛΗΝΙΚΟΥΑΡΓΥΡΟΥΠΟΛΗΣ": "ΠΕ Νοτίου Τομέα Αθηνών",
    # ── Αττική: Δυτικός Τομέας Αθηνών ──
    "ΠΕΡΙΣΤΕΡΙΟΥ": "ΠΕ Δυτικού Τομέα Αθηνών",
    "ΙΛΙΟΥ": "ΠΕ Δυτικού Τομέα Αθηνών",
    "ΧΑΙΔΑΡΙΟΥ": "ΠΕ Δυτικού Τομέα Αθηνών",
    "ΑΙΓΑΛΕΩ": "ΠΕ Δυτικού Τομέα Αθηνών",
    "ΠΕΤΡΟΥΠΟΛΕΩΣ": "ΠΕ Δυτικού Τομέα Αθηνών",
    "ΑΓΙΑΣ ΒΑΡΒΑΡΑΣ": "ΠΕ Δυτικού Τομέα Αθηνών",
    "ΑΓΙΩΝ ΑΝΑΡΓΥΡΩΝ ΚΑΜΑΤΕΡΟΥ": "ΠΕ Δυτικού Τομέα Αθηνών",
    # ── Αττική: Βόρειος Τομέας Αθηνών ──
    "ΧΑΛΑΝΔΡΙΟΥ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΑΜΑΡΟΥΣΙΟΥ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΚΗΦΙΣΙΑΣ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΠΕΝΤΕΛΗΣ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΝΕΑΣ ΙΩΝΙΑΣ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΜΕΤΑΜΟΡΦΩΣΕΩΣ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΑΓΙΑΣ ΠΑΡΑΣΚΕΥΗΣ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΠΑΠΑΓΟΥΧΟΛΑΡΓΟΥ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΒΡΙΛΗΣΣΙΩΝ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΛΥΚΟΒΡΥΣΗΣ ΠΕΥΚΗΣ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΦΙΛΟΘΕΗΣΨΥΧΙΚΟΥ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΑΧΑΡΝΩΝ": "ΠΕ Βορείου Τομέα Αθηνών",
    "ΗΡΑΚΛΕΙΟΥ": "ΠΕ Βορείου Τομέα Αθηνών",
    # ── ΠΕ Πειραιώς ──
    "ΠΕΙΡΑΙΩΣ": "ΠΕ Πειραιώς",
    "ΝΙΚΑΙΑΣΑΓΙΟΥ ΙΩΑΝΝΗ ΡΕΝΤΗ": "ΠΕ Πειραιώς",
    "ΚΕΡΑΤΣΙΝΙΟΥΔΡΑΠΕΤΣΩΝΑΣ": "ΠΕ Πειραιώς",
    "ΚΟΡΥΔΑΛΛΟΥ": "ΠΕ Πειραιώς",
    "ΠΕΡΑΜΑΤΟΣ": "ΠΕ Πειραιώς",
    "ΣΑΛΑΜΙΝΑΣ": "ΠΕ Νήσων Αττικής",
    "ΠΟΡΟΥ": "ΠΕ Νήσων Αττικής",
    "ΣΑΡΩΝΙΚΟΥ": "ΠΕ Νήσων Αττικής",
    "ΤΡΟΙΖΗΝΙΑΣ ΜΕΘΑΝΩΝ": "ΠΕ Νήσων Αττικής",
    # ── ΠΕ Ανατολικής Αττικής ──
    "ΠΑΛΛΗΝΗΣ": "ΠΕ Ανατολικής Αττικής",
    "ΚΡΩΠΙΑΣ": "ΠΕ Ανατολικής Αττικής",
    "ΜΑΡΚΟΠΟΥΛΟΥ ΜΕΣΟΓΑΙΑΣ": "ΠΕ Ανατολικής Αττικής",
    "ΜΑΡΚΟΠΟΥΛΟΥ": "ΠΕ Ανατολικής Αττικής",
    "ΛΑΥΡΕΩΤΙΚΗΣ": "ΠΕ Ανατολικής Αττικής",
    "ΣΠΑΤΩΝΑΡΤΕΜΙΔΟΣ": "ΠΕ Ανατολικής Αττικής",
    "ΜΑΡΑΘΩΝΟΣ": "ΠΕ Ανατολικής Αττικής",
    "ΡΑΦΗΝΑΣΠΙΚΕΡΜΙΟΥ": "ΠΕ Ανατολικής Αττικής",
    "ΔΙΟΝΥΣΟΥ": "ΠΕ Ανατολικής Αττικής",
    "ΩΡΩΠΟΥ": "ΠΕ Ανατολικής Αττικής",
    "ΘΕΡΜΑΙΚΟΥ": "ΠΕ Ανατολικής Αττικής",
    # ── ΠΕ Δυτικής Αττικής ──
    "ΕΛΕΥΣΙΝΑΣ": "ΠΕ Δυτικής Αττικής",
    "ΕΛΕΥΣΙΝΟΣ": "ΠΕ Δυτικής Αττικής",
    "ΑΣΠΡΟΠΥΡΓΟΥ": "ΠΕ Δυτικής Αττικής",
    "ΜΑΝΔΡΑΣ ΕΙΔΥΛΛΙΑΣ": "ΠΕ Δυτικής Αττικής",
    "ΜΕΓΑΡΕΩΝ": "ΠΕ Δυτικής Αττικής",
    "ΦΥΛΗΣ": "ΠΕ Δυτικής Αττικής",
    # ── ΠΕ Θεσσαλονίκης ──
    "ΘΕΣΣΑΛΟΝΙΚΗΣ": "ΠΕ Θεσσαλονίκης",
    "ΚΑΛΑΜΑΡΙΑΣ": "ΠΕ Θεσσαλονίκης",
    "ΠΑΥΛΟΥ ΜΕΛΑ": "ΠΕ Θεσσαλονίκης",
    "ΚΟΡΔΕΛΙΟΥΕΥΟΣΜΟΥ": "ΠΕ Θεσσαλονίκης",
    "ΝΕΑΠΟΛΗΣΣΥΚΕΩΝ": "ΠΕ Θεσσαλονίκης",
    "ΑΜΠΕΛΟΚΗΠΩΝΜΕΝΕΜΕΝΗΣ": "ΠΕ Θεσσαλονίκης",
    "ΘΕΡΜΗΣ": "ΠΕ Θεσσαλονίκης",
    "ΔΕΛΤΑ": "ΠΕ Θεσσαλονίκης",
    "ΩΡΑΙΟΚΑΣΤΡΟΥ": "ΠΕ Θεσσαλονίκης",
    "ΠΥΛΑΙΑΣΧΟΡΤΙΑΤΗ": "ΠΕ Θεσσαλονίκης",
    "ΛΑΓΚΑΔΑ": "ΠΕ Θεσσαλονίκης",
    "ΧΑΛΚΗΔΟΝΟΣ": "ΠΕ Θεσσαλονίκης",
    "ΝΕΑΣ ΠΡΟΠΟΝΤΙΔΑΣ": "ΠΕ Χαλκιδικής",
    # ── ΠΕ Χαλκιδικής ──
    "ΠΟΛΥΓΥΡΟΥ": "ΠΕ Χαλκιδικής",
    "ΚΑΣΣΑΝΔΡΑΣ": "ΠΕ Χαλκιδικής",
    "ΣΙΘΩΝΙΑΣ": "ΠΕ Χαλκιδικής",
    ...
    "ΣΚΥΔΡΑΣ": "ΠΕ Πέλλας",
    # ── ΠΕ Ημαθίας ──
    "ΑΛΕΞΑΝΔΡΕΙΑΣ": "ΠΕ Ημαθίας",
    "ΒΕΡΟΙΑΣ": "ΠΕ Ημαθίας",
    "ΗΡΩΙΚΗΣ ΠΟΛΕΩΣ ΝΑΟΥΣΑΣ": "ΠΕ Ημαθίας",
    "ΝΑΟΥΣΑΣ": "ΠΕ Ημαθίας",
    # ── ΠΕ Πιερίας ──
    ...
    "ΠΑΓΓΑΙΟΥ": "ΠΕ Καβάλας",
    # ── ΠΕ Λάρισας ──
    "ΛΑΡΙΣΑΙΩΝ": "ΠΕ Λάρισας",
    "ΛΑΡΙΣΑΣ": "ΠΕ Λάρισας",
    "ΤΥΡΝΑΒΟΥ": "ΠΕ Λάρισας",
    "ΕΛΑΣΣΟΝΑΣ": "ΠΕ Λάρισας",
    "ΤΕΜΠΩΝ": "ΠΕ Λάρισας",
    "ΦΑΡΣΑΛΩΝ": "ΠΕ Λάρισας",
    "ΚΙΛΕΛΕΡ": "ΠΕ Λάρισας",
    # ── ΠΕ Μαγνησίας ──
    "ΒΟΛΟΥ": "ΠΕ Μαγνησίας",
    "ΝΕΑΣ ΙΩΝΙΑΣ ΜΑΓΝΗΣΙΑΣ": "ΠΕ Μαγνησίας",
    "ΑΛΜΥΡΟΥ": "ΠΕ Μαγνησίας",
    "ΖΑΓΟΡΑΣ ΜΟΥΡΕΣΙΟΥ": "ΠΕ Μαγνησίας",
    # ── ΠΕ Τρικάλων ──
    "ΤΡΙΚΚΑΙΩΝ": "ΠΕ Τρικάλων",
    "ΤΡΙΚΑΛΩΝ": "ΠΕ Τρικάλων",
    "ΜΕΤΕΩΡΩΝ": "ΠΕ Τρικάλων",
    "ΠΥΛΗΣ": "ΠΕ Τρικάλων",
    # ── ΠΕ Καρδίτσας ──
    "ΚΑΡΔΙΤΣΗΣ": "ΠΕ Καρδίτσας",
    "ΚΑΡΔΙΤΣΑΣ": "ΠΕ Καρδίτσας",
    "ΛΙΜΝΗΣ ΠΛΑΣΤΗΡΑ": "ΠΕ Καρδίτσας",
    # ── ΠΕ Φθιώτιδας ──
    "ΛΑΜΙΕΩΝ": "ΠΕ Φθιώτιδας",
    "ΛΑΜΙΑΣ": "ΠΕ Φθιώτιδας",
    "ΜΑΚΡΑΚΩΜΗΣ": "ΠΕ Φθιώτιδας",
    "ΛΟΚΡΩΝ": "ΠΕ Φθιώτιδας",
    # ── ΠΕ Εύβοιας ──
    "ΧΑΛΚΙΔΕΩΝ": "ΠΕ Εύβοιας",
    "ΧΑΛΚΙΔΑΣ": "ΠΕ Εύβοιας",
    "ΙΣΤΙΑΙΑΣΑΙΔΗΨΟΥ": "ΠΕ Εύβοιας",
    "ΚΑΡΥΣΤΟΥ": "ΠΕ Εύβοιας",
    "ΚΥΜΗΣΑΛΙΒΕΡΙΟΥ": "ΠΕ Εύβοιας",
    # ── ΠΕ Βοιωτίας ──
    "ΘΗΒΑΙΩΝ": "ΠΕ Βοιωτίας",
    "ΛΕΒΑΔΕΩΝ": "ΠΕ Βοιωτίας",
    "ΟΡΧΟΜΕΝΟΥ": "ΠΕ Βοιωτίας",
    # ── ΠΕ Φωκίδας ──
    "ΑΜΦΙΣΣΗΣ": "ΠΕ Φωκίδας",
    "ΔΕΛΦΩΝ": "ΠΕ Φωκίδας",
    # ── ΠΕ Ευρυτανίας ──
    "ΚΑΡΠΕΝΗΣΙΟΥ": "ΠΕ Ευρυτανίας",
    # ── ΠΕ Κορινθίας ──
    "ΚΟΡΙΝΘΙΩΝ": "ΠΕ Κορινθίας",
    "ΛΟΥΤΡΑΚΙΟΥΠΕΡΑΧΩΡΑΣΑΓΙΩΝ ΘΕΟΔΩΡΩΝ": "ΠΕ Κορινθίας",
    "ΞΥΛΟΚΑΣΤΡΟΥΕΥΡΩΣΤΙΝΗΣ": "ΠΕ Κορινθίας",
    # ── ΠΕ Αχαΐας ──
    "ΠΑΤΡΕΩΝ": "ΠΕ Αχαΐας",
    "ΑΙΓΙΑΛΕΙΑΣ": "ΠΕ Αχαΐας",
    "ΔΥΤΙΚΗΣ ΑΧΑΙΑΣ": "ΠΕ Αχαΐας",
    # ── ΠΕ Αιτωλοακαρνανίας ──
    "ΑΓΡΙΝΙΟΥ": "ΠΕ Αιτωλοακαρνανίας",
    "ΙΕΡΑΣ ΠΟΛΕΩΣ ΜΕΣΟΛΟΓΓΙΟΥ": "ΠΕ Αιτωλοακαρνανίας",
    "ΜΕΣΟΛΟΓΓΙΟΥ": "ΠΕ Αιτωλοακαρνανίας",
    "ΝΑΥΠΑΚΤΙΑΣ": "ΠΕ Αιτωλοακαρνανίας",
    "ΑΜΦΙΛΟΧΙΑΣ": "ΠΕ Αιτωλοακαρνανίας",
    # ── ΠΕ Αρκαδίας ──
    "ΤΡΙΠΟΛΗΣ": "ΠΕ Αρκαδίας",
    "ΒΟΡΕΙΑΣ ΚΥΝΟΥΡΙΑΣ": "ΠΕ Αρκαδίας",
    "ΝΟΤΙΑΣ ΚΥΝΟΥΡΙΑΣ": "ΠΕ Αρκαδίας",
    "ΓΟΡΤΥΝΙΑΣ": "ΠΕ Αρκαδίας",
    "ΜΕΓΑΛΟΠΟΛΗΣ": "ΠΕ Αρκαδίας",
    # ── ΠΕ Μεσσηνίας ──
    "ΚΑΛΑΜΑΤΑΣ": "ΠΕ Μεσσηνίας",
    "ΜΕΣΣΗΝΗΣ": "ΠΕ Μεσσηνίας",
    "ΠΥΛΟΥΝΕΣΤΟΡΟΣ": "ΠΕ Μεσσηνίας",
    "ΤΡΙΦΥΛΙΑΣ": "ΠΕ Μεσσηνίας",
    "ΖΑΧΑΡΩΣ": "ΠΕ Ηλείας",
    # ── ΠΕ Λακωνίας ──
    "ΣΠΑΡΤΗΣ": "ΠΕ Λακωνίας",
    "ΜΟΝΕΜΒΑΣΙΑΣ": "ΠΕ Λακωνίας",
    "ΑΝΑΤΟΛΙΚΗΣ ΜΑΝΗΣ": "ΠΕ Λακωνίας",
    # ── ΠΕ Αργολίδας ──
    "ΝΑΥΠΛΙΕΩΝ": "ΠΕ Αργολίδας",
    "ΑΡΓΟΥΣΜΥΚΗΝΩΝ": "ΠΕ Αργολίδας",
    "ΕΡΜΙΟΝΙΔΑΣ": "ΠΕ Αργολίδας",
    "ΠΟΡΟΥ ΤΡΟΙΖΗΝΙΑΣ ΙΔΙΟΚΤΗΣΙΑΣ": "ΠΕ Αργολίδας",
    # ── ΠΕ Ηλείας ──
    "ΠΥΡΓΟΥ": "ΠΕ Ηλείας",
    "ΗΛΙΔΑΣ": "ΠΕ Ηλείας",
    # ── ΠΕ Ιωαννίνων ──
    "ΙΩΑΝΝΙΤΩΝ": "ΠΕ Ιωαννίνων",
    "ΖΑΓΟΡΙΟΥ": "ΠΕ Ιωαννίνων",
    # ── ΠΕ Άρτας ──
    "ΑΡΤΑΙΩΝ": "ΠΕ Άρτας",
    "ΝΙΚΟΛΑΟΥ ΣΚΟΥΦΑ": "ΠΕ Άρτας",
    # ── ΠΕ Πρέβεζας ──
    "ΠΡΕΒΕΖΑΣ": "ΠΕ Πρέβεζας",
    "ΖΗΡΟΥ": "ΠΕ Πρέβεζας",
    # ── ΠΕ Θεσπρωτίας ──
    "ΗΓΟΥΜΕΝΙΤΣΑΣ": "ΠΕ Θεσπρωτίας",
    "ΠΑΡΓΑΣ": "ΠΕ Θεσπρωτίας",
    # ── ΠΕ Καβάλας ──
    "ΚΑΒΑΛΑΣ": "ΠΕ Καβάλας",
    # ── ΠΕ Δράμας ──
    "ΔΡΑΜΑΣ": "ΠΕ Δράμας",
    "ΚΑΤΩ ΝΕΥΡΟΚΟΠΙΟΥ": "ΠΕ Δράμας",
    # ── ΠΕ Ξάνθης ──
    "ΞΑΝΘΗΣ": "ΠΕ Ξάνθης",
    # ── ΠΕ Ροδόπης ──
    ...
    "ΟΡΕΣΤΙΑΔΑΣ": "ΠΕ Έβρου",
    "ΔΙΔΥΜΟΤΕΙΧΟΥ": "ΠΕ Έβρου",
    # ── ΠΕ Γρεβενών ──
    "ΓΡΕΒΕΝΩΝ": "ΠΕ Γρεβενών",
    # ── ΠΕ Κοζάνης ──
    "ΚΟΖΑΝΗΣ": "ΠΕ Κοζάνης",
    "ΕΟΡΔΑΙΑΣ": "ΠΕ Κοζάνης",
    "ΒΟΙΟΥ": "ΠΕ Κοζάνης",
    # ── ΠΕ Φλώρινας ──
    "ΦΛΩΡΙΝΑΣ": "ΠΕ Φλώρινας",
    # ── ΠΕ Καστοριάς ──
    "ΚΑΣΤΟΡΙΑΣ": "ΠΕ Καστοριάς",
    "ΑΡΓΟΥΣ ΟΡΕΣΤΙΚΟΥ": "ΠΕ Καστοριάς",
    # ── ΠΕ Ηρακλείου (Κρήτη) ──
    "ΗΡΑΚΛΕΙΟΥ ΚΡΗΤΗΣ": "ΠΕ Ηρακλείου",
    "ΑΡΧΑΝΩΝΑΣΤΕΡΟΥΣΙΩΝ": "ΠΕ Ηρακλείου",
    "ΜΙΝΩΑ ΠΕΔΙΑΔΑΣ": "ΠΕ Ηρακλείου",
    "ΦΑΙΣΤΟΥ": "ΠΕ Ηρακλείου",
    # ── ΠΕ Χανίων ──
    "ΧΑΝΙΩΝ": "ΠΕ Χανίων",
    "ΑΠΟΚΟΡΩΝΟΥ": "ΠΕ Χανίων",
    "ΚΙΣΣΑΜΟΥ": "ΠΕ Χανίων",
    "ΠΛΑΤΑΝΙΑ": "ΠΕ Χανίων",
    # ── ΠΕ Ρεθύμνης ──
    "ΡΕΘΥΜΝΗΣ": "ΠΕ Ρεθύμνης",
    "ΜΥΛΟΠΟΤΑΜΟΥ": "ΠΕ Ρεθύμνης",
    # ── ΠΕ Λασιθίου ──
    "ΑΓΙΟΥ ΝΙΚΟΛΑΟΥ": "ΠΕ Λασιθίου",
    "ΙΕΡΑΠΕΤΡΑΣ": "ΠΕ Λασιθίου",
    "ΣΗΤΕΙΑΣ": "ΠΕ Λασιθίου",
    # ── Νησιά Αιγαίου ──
    "ΡΟΔΟΥ": "ΠΕ Ρόδου",
    ...
    "ΧΙΟΥ": "ΠΕ Χίου",
    "ΣΑΜΟΥ": "ΠΕ Σάμου",
    "ΑΝΑΤΟΛΙΚΗΣ ΣΑΜΟΥ": "ΠΕ Σάμου",
    "ΔΥΤΙΚΗΣ ΣΑΜΟΥ": "ΠΕ Σάμου",
    "ΙΚΑΡΙΑΣ": "ΠΕ Ικαρίας",
    "ΘΑΣΟΥ": "ΠΕ Θάσου",
    "ΛΗΜΝΟΥ": "ΠΕ Λήμνου",
    # ── Κυκλάδες ──
    ...
    "ΜΗΛΟΥ": "ΠΕ Μήλου",
    "ΣΚΙΑΘΟΥ": "ΠΕ Σποράδων",
    "ΣΚΟΠΕΛΟΥ": "ΠΕ Σποράδων",
    # ── Ιόνια ──
    "ΚΕΝΤΡΙΚΗΣ ΚΕΡΚΥΡΑΣ ΔΙΑΠΟΝΤΙΩΝ ΝΗΣΩΝ": "ΠΕ Κέρκυρας",
    "ΚΕΡΚΥΡΑΣ": "ΠΕ Κέρκυρας",
    "ΖΑΚΥΝΘΙΩΝ": "ΠΕ Ζακύνθου",
    "ΖΑΚΥΝΘΟΥ": "ΠΕ Ζακύνθου",
    "ΑΡΓΟΣΤΟΛΙΟΥ": "ΠΕ Κεφαλονιάς",
    "ΚΕΦΑΛΛΗΝΙΑΣ": "ΠΕ Κεφαλονιάς",
    "ΛΕΥΚΑΔΑΣ": "ΠΕ Λευκάδας",
    "ΜΕΓΑΝΗΣΙΟΥ": "ΠΕ Λευκάδας",
}
